...
namespace RDS {
	...
	{
	public:
		HistoryForm(RDS_main_Form^ pForm)
		{
			InitializeComponent();
			//
...
private: System::Windows::Forms::Button^  btn_ToOperationList;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->btn_ToOperationList = (gcnew System::Windows::Forms::Button());
			...
			this->tableLayoutPanel_BG->TabIndex = 1;
			// 
			...
			this->flowLayoutPanel_UID->Controls->Add(this->btn_ToOperationList);
			...
			this->flowLayoutPanel_UID->Size = System::Drawing::Size(258, 129);
			...
			this->textBox_UID_in->Text = L"12345";
			this->textBox_UID_in->TextAlign = System::Windows::Forms::HorizontalAlignment::Center;
			// 
			// btn_ToOperationList
			// 
			this->btn_ToOperationList->Font = (gcnew System::Drawing::Font(L"Cambria", 12, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->btn_ToOperationList->Location = System::Drawing::Point(20, 73);
			this->btn_ToOperationList->Margin = System::Windows::Forms::Padding(20, 8, 2, 2);
			this->btn_ToOperationList->Name = L"btn_ToOperationList";
			this->btn_ToOperationList->Size = System::Drawing::Size(207, 46);
			this->btn_ToOperationList->TabIndex = 2;
			this->btn_ToOperationList->Text = L"Operation Records List";
			this->btn_ToOperationList->UseVisualStyleBackColor = true;
			this->btn_ToOperationList->Click += gcnew System::EventHandler(this, &HistoryForm::btn_ToOperationList_Click);
			// 
			...
			this->flowLayoutPanel_Date->Location = System::Drawing::Point(3, 138);
			...
			// panel0
			// 
			this->panel0->BackColor = System::Drawing::Color::Yellow;
			...
			this->panel0->Click += gcnew System::EventHandler(this, &HistoryForm::label0_Click);
			// 
			// label0
			// 
			...
			this->label0->Click += gcnew System::EventHandler(this, &HistoryForm::label0_Click);
			// 
			// panel1
			// 
			...
			this->panel1->Click += gcnew System::EventHandler(this, &HistoryForm::label1_Click);
			// 
			// label1
			// 
			...
			this->label1->Click += gcnew System::EventHandler(this, &HistoryForm::label1_Click);
			// 
			// panel2
			// 
			...
			this->panel2->Click += gcnew System::EventHandler(this, &HistoryForm::label2_Click);
			// 
			// label2
			// 
			...
			this->label2->Click += gcnew System::EventHandler(this, &HistoryForm::label2_Click);
			// 
			// panel3
			// 
			...
			this->panel3->Click += gcnew System::EventHandler(this, &HistoryForm::label3_Click);
			// 
			// label3
			// 
			...
			this->label3->Click += gcnew System::EventHandler(this, &HistoryForm::label3_Click);
			// 
			// panel4
			// 
			...
			this->panel4->Click += gcnew System::EventHandler(this, &HistoryForm::label4_Click);
			// 
			// label4
			// 
			...
			this->label4->Click += gcnew System::EventHandler(this, &HistoryForm::label4_Click);
			// 
			// panel5
			// 
			...
			this->panel5->Click += gcnew System::EventHandler(this, &HistoryForm::label5_Click);
			// 
			// label5
			// 
			...
			this->label5->Click += gcnew System::EventHandler(this, &HistoryForm::label5_Click);
			// 
			// panel6
			// 
			...
			this->panel6->Click += gcnew System::EventHandler(this, &HistoryForm::label6_Click);
			// 
			// label6
			// 
			...
			this->label6->Click += gcnew System::EventHandler(this, &HistoryForm::label6_Click);
			// 
			// panel7
			// 
			...
			this->panel7->Click += gcnew System::EventHandler(this, &HistoryForm::label7_Click);
			// 
			// label7
			// 
			...
			this->label7->Click += gcnew System::EventHandler(this, &HistoryForm::label7_Click);
			// 
			// panel8
			// 
			...
			this->panel8->Click += gcnew System::EventHandler(this, &HistoryForm::label8_Click);
			// 
			// label8
			// 
			...
			this->label8->Click += gcnew System::EventHandler(this, &HistoryForm::label8_Click);
			// 
			// panel9
			// 
			...
			this->panel9->Click += gcnew System::EventHandler(this, &HistoryForm::label9_Click);
			// 
			// label9
			// 
			...
			this->label9->Click += gcnew System::EventHandler(this, &HistoryForm::label9_Click);
			// 
			// panel_Btn
			// 
			...
			this->btn_NextPage->Click += gcnew System::EventHandler(this, &HistoryForm::btn_NextPage_Click);
			// 
			// btn_PrePage
			// 
			...
			this->btn_PrePage->Click += gcnew System::EventHandler(this, &HistoryForm::btn_PrePage_Click);
			// 
			...
			this->flowLayoutPanel_Right->Controls->Add(this->panel_RDSreport);
			...
			this->panel_SpaSerial->Location = System::Drawing::Point(1, 1);
			...
			this->panel_Owner->Location = System::Drawing::Point(1, 48);
			...
			this->textBox_owner->Font = (gcnew System::Drawing::Font(L"Cambria", 14.25F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->textBox_owner->Location = System::Drawing::Point(127, 8);
			...
			this->lbl_owner->Location = System::Drawing::Point(23, 9);
			...
			this->richTextBox_equipments->Font = (gcnew System::Drawing::Font(L"Cambria", 14.25F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->richTextBox_equipments->Location = System::Drawing::Point(14, 33);
			this->richTextBox_equipments->Name = L"richTextBox_equipments";
			this->richTextBox_equipments->ReadOnly = true;
			this->richTextBox_equipments->Size = System::Drawing::Size(681, 63);
			...
			// panel_replace
			// 
			this->panel_replace->BackColor = System::Drawing::Color::Teal;
			...
			// richTextBox_replace
			// 
			this->richTextBox_replace->BackColor = System::Drawing::Color::LightBlue;
			...
			this->richTextBox_replace->ReadOnly = true;
			...
			this->richTextBox_comment->ReadOnly = true;
			...
			this->panel_RDSreport->Location = System::Drawing::Point(1, 586);
			this->panel_RDSreport->Margin = System::Windows::Forms::Padding(1);
			this->panel_RDSreport->Name = L"panel_RDSreport";
			this->panel_RDSreport->Size = System::Drawing::Size(710, 72);
			this->panel_RDSreport->TabIndex = 7;
			// 
			// button_fullReport
			// 
			this->button_fullReport->Font = (gcnew System::Drawing::Font(L"Cambria", 14.25F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->button_fullReport->Location = System::Drawing::Point(212, 18);
			...
			this->button_fullReport->Click += gcnew System::EventHandler(this, &HistoryForm::button_fullReport_Click);
			// 
			// HistoryForm
			// 
			...
			this->Text = L"History of Service";
			this->TopMost = true;
			this->FormClosed += gcnew System::Windows::Forms::FormClosedEventHandler(this, &HistoryForm::HistoryForm_FormClosed);
...
#pragma endregion
		...
		//for directory scan
public:		int getReportList(int page, String^ UID);
private:	void showBriefReport(String^ readFileName);
			void initial_display();

private: System::Void btn_ToOperationList_Click(System::Object^  sender, System::EventArgs^  e);
...
private: System::Void HistoryForm_FormClosed(System::Object^  sender, System::Windows::Forms::FormClosedEventArgs^  e);
};
}
